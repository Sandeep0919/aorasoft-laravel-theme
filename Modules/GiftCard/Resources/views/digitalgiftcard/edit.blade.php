                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                 <label class="primary_input_label" for="gift_name">{{ __('common.name') }}
                                                   <span class="text-danger">*</span></label>
                                                <input class="primary_input_field" type="text" id="gift_name"
                                                    name="gift_name" autocomplete="off" value="{{old('gift_name')?? $giftCards->gift_name}}"
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                    for="descriptionOne">{{ __('common.description') }}</label>

                                                <textarea name="descriptionOne" class="summernote" 
                                                    id="descriptionOne" class="">{{ $giftCards->descriptionOne }}
                                                </textarea>
                                            </div>
                                                                ...
                                                                <nav>
                                                                    <div class="nav nav-tabs border-0" id="section-nav-tab" role="tablist">
                                                                        @foreach($giftCards->addGiftCard as $key=>$data)
                                                                            <button class="nav-link {{$key == 0 ? 'show active' : ''}}" id="nav-home-tab" data-toggle="tab" data-target="#secton-{{$key+1}}" type="button" role="tab" aria-selected="true">
                                                                            <span>{{__('gift_card.section')}} {{$key+1}}</span>
                                                                            <i class="ti-close"></i>
                                                                            </button>
                                                                        @endforeach 
                                                                    </div>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-lg-6">
                                                                                    <div class="primary_input mb-25">
                                                                                        ...
                                                                                        <input class="primary_input_field date_show" type="text"
                                                                                            id="gift_expire_date_[{{$key}}]" 
                                                                                            name="section[{{$key}}][gift_expire_date]" autocomplete="off"
                                                                                    ...
                                                                                    <div class="primary_input">
                                                                                        ...
                                                                                        <div class="d-flex align-items-center flex-wrap">
                                                                                            <div class="flex-grow-1 d-flex align-items-center 
                                                                                                cursor_pointer manual_coupon_radio" id="">
                                                                                                ...
                                                                                                <label for="manual_coupon" class="text-capitalize mb-0 cursor_pointer">
                                                                                                    {{__('gift_card.manual_coupon_code_input')}}</label>
                                                                                            </div>
                                                                                            <div class="flex-grow-1 d-flex align-items-center cursor_pointer bluk_coupon_radio" id="">
                                                                                                ...
                                                                                                <label for="bluk_coupon" class="text-capitalize mb-0 cursor_pointer">
                                                                                                    {{__('gift_card.bulk_coupon_code_input')}} (<span class="text-primary">CSV,
                                                                                                        .xls, .xlsx</span>)</label>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div id="manual_coupon2" class="active">
                                                                                            <div class="flex-grow-1">
                                                                                                ...
                                                                                                <div class="gift_manual d-flex align-items-center mt-3">
                                                                                                    <div class="primary_input">
                                                                                                        <input class="primary_input_field" name="section[{{$key}}][gift_selling_coupon][]" value="{{$data->gift_selling_coupon}}" id="gift_selling_coupon_[{{$key}}]" type="text" placeholder="">                                                                                                    </div>                                               
                                                                                                    <div class="flex-grow-1">
                                                                                                        <button type="button" class="primary-btn radius_30px p-2 fix-gr-bg rounded-circle 
                                                                                                            gift_code_clone">
                                            ...
                                            <div class="row mb-25">
                                                    ...
                                                    <div class="primary_input">
                                                        ...
                                                        <div class="primary_file_uploader">
                                                            <input class="primary-input" type="text"
                                                                ...
                                                                placeholder="{{ __('product.product_image') }}"
                                                                readonly="">
                                                ...
                                                <div class="col-xl-4 col-lg-4">
                                                    <div class="thumb_img_div_one">
                                                        <img id="ThumbnailImgOne" src="{{ showImage($giftCards->thumbnail_image_one ?? 'backend/img/default.png') }}">
                                                    </div>
                                                </div>

                                                <div class="col-lg-4">
                                                    <div id="gallery_img_prev_one">
                                                    </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row  mb-25">
                                                <div class="col-lg-8">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                            for="">{{ __('product.gift_card_image') }}
                                                            ({{ getNumberTranslate(400) }} X
                                                            {{ getNumberTranslate(400) }}){{ __('common.px') }}
                                                            <span class="text-danger">*</span></label>
                                                        <div class="primary_file_uploader">
                                                            <input class="primary-input" type="text"
                                                                id="thumbnail_image_file_two"
                                                                placeholder="{{ __('product.gift_card_image') }}"
                                                                readonly="">
                                                            <button class="" type="button">
                                                                <label class="primary-btn small fix-gr-bg"
                                                                    for="thumbnail_image_two">{{ __('product.Browse') }}
                                                                </label>
                                                                <input type="file" class="d-none"
                                                                    name="thumbnail_image_two" id="thumbnail_image_two">
                                                            </button>
                                                        </div>
                                                ...
                                                <div class="col-xl-4 col-lg-4">
                                                    <div class="thumb_img_div_two">
                                                        <img id="ThumbnailImgTwo"
                                                            src="{{ showImage($giftCards->thumbnail_image_two ?? 'backend/img/default.png') }}"
                                                            alt="">
                                                    </div>
                                                </div>

                                                <div class="col-lg-4">
                                                    <div id="gallery_img_prev_two">
        ...
        (function($) {
            ...
            $(document).ready(function() {
                $(document).on('click', '#gift_card_prod', function(e) {
                    $(this).closest('.add-visitor').find('#lg-toggle-8').removeClass('col-lg-8')
                        .addClass('col-lg-6');
                    $(this).closest('.add-visitor').find('#lg-toggle-4').removeClass('col-lg-4')
                        .addClass('col-lg-6');
                    $(this).closest('.add-visitor').find('#redeem_card_row').addClass('d-none');
                    $(this).closest('.add-visitor').find('#gift_card').removeClass('d-none');
                    $(this).closest('.add-visitor').find('#lg-toggle-4 #giftt_card_row').removeClass(
                        'd-none');
                    $(this).closest('.add-visitor').find('#lg-toggle-4 #redem_card_row').addClass(
                        'd-none');
                    $('#note_editor').hide()
                })
                $(document).on('click', '#redeem_card', function(e) {
                    $(this).closest('.add-visitor').find('#lg-toggle-8').addClass('col-lg-8')
                        .removeClass('col-lg-6');
                    $(this).closest('.add-visitor').find('#lg-toggle-4').addClass('col-lg-4')
                        .removeClass('col-lg-6');
                    $(this).closest('.add-visitor').find('#gift_card').addClass('d-none');
                    $(this).closest('.add-visitor').find('#redeem_card_row').removeClass('d-none');
                    $(this).closest('.add-visitor').find('#lg-toggle-4 #redem_card_row').removeClass(
                        'd-none');
                    $(this).closest('.add-visitor').find('#lg-toggle-4 #giftt_card_row').addClass(
                        'd-none');
                    $('#note_editor').show()

                })

                // new js create by arif
                ...
                $(document).on('click', '.add_single_variant_row_one', function() {
                    ...
                    if($('#section-nav-tab').length){
                        $('#section-nav-tab').append(`
                            <button class="nav-link" id="nav-home-tab-${sections}" data-toggle="tab" data-target="#secton-${sections}" type="button"  role="tab" aria-selected="true">
                                <span>{{__('gift_card.section')}} ${sections}</span>
                                <i class="ti-close"></i>
                            </button>`);
                                        ...
                                        <div class="col-lg-6">
                                            <div class="primary_input mb-25">
                                                ...
                                                <input class="primary_input_field date_show" type="text"
                                                    ...
                                                    name="section[${sections}][gift_expire_date]" autocomplete="off"
                                                    value="" placeholder="00">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                            ...
                            <div class="gift_box">
                                <nav>
                                    <div class="nav nav-tabs border-0" id="section-nav-tab" role="tablist">
                                        ...
                                        <span>{{__('gift_card.section')}}</span>
                                        <i class="ti-close"></i>
                                        </button>
                    ...
                    $('#gift_expire_date_'+sections).daterangepicker({
                        "timePicker": false,
                        "linkedCalendars": false,
                        "autoUpdateInput": false,
                        "showCustomRangeLabel": false,
                        ...
                        console.log($('#gift_expire_date_'+sections));
                        $('#gift_expire_date_'+sections).val(start.format('DD-MM-YYYY') + ' to ' + end.format('DD-MM-YYYY'));
