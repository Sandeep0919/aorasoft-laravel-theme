                ...
                <div class="white_box_50px box_shadow_white" id="printableArea">
                    <div class="row pb-30 border-bottom">
                        ...
                        <div class="-md-6 col-lg-6 text-right">
                            <h4>  {{ __('product.card_number') }} : {{$giftCards->card_number}}</h4>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <table class="table-borderless clone_line_table">
                                ...
                                <tr>
                                    ...
                                    <td>: {{$giftCards->gift_name}}</td>
                                </tr>
                                <tr>
                                    <td>{{__('common.description')}}</td>
                                    <td>: {{$giftCards->descriptionOne}}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>: {{date(app('general_setting')->dateFormat->format,strtotime($giftCards->start_date))}}</td>
                                </tr>
                                <tr>
                                    <td>{{__('common.end_date')}}</td>
                                    <td>: {{date(app('general_setting')->dateFormat->format,strtotime($giftCards->end_date))}}</td>
                                </tr>
