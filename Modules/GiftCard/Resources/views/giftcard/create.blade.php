    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-0">
            ...
            <div id="formHtml" class="col-lg-12">
                <div class="white-box">
                    <form action="{{ route('admin.giftcard.store') }}" id="add_form" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12" id="note_editor">
                                    <div class="primary_input mb-25">
                                        ...
                                        <textarea name="description" class="summernote" id="description" class="">{{ 
                                            ...
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                    for="gift_expire_date">{{__('gift_card.gift_expire_date')}}: <span
                                                        class="text-danger">*</span></label>
                                                <input class="primary_input_field popUpDateRange" data-id="${sections}" type="" min="1"
