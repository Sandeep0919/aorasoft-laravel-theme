...
@endphp
@if(url()->current() == url('/'))
<div id="about_section" class="amaz_section section_spacing4 {{$about_section->status == 0?'d-none':''}}">
    <div class="container">
        <div class="row">
            <div class="col-12">
...
<!-- FOOTER::START  -->
    ...
    <!--    </div>-->
    <!--</footer>-->
    <footer id="footer-section8" style="background-color: #1a1a1a;  padding:60px 0px;"
        class="builder-bg footer-style8 padding-60px-tb xs-padding-40px-tb footer-class">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12 sm-text-center sm-margin-five-bottom ">
                    <!-- logo -->
                    <a class="margin-eight-bottom display-inline-block inner-link" href="#home"><img
                            src="{{url('/')}}/public/frontend/amazy/img/logo_footer.png" style="height: 150px;" data-img-size="(W)163px X (H)39px" alt=""></a>
                    <!-- end logo -->
                </div>
                <!-- links -->
                <div class="col-md-2 col-sm-4 col-xs-12 xs-margin-nine-bottom xs-text-center">
                    <ul class="links">
                        <li
                            class="text-medium margin-seven-bottom font-weight-600 text-white tz-text xs-margin-one-half-bottom">
                            Contact us</li>
                        <li><a class="tz-text text-medium-gray inner-link" href="{{url('/')}}/contact-us">Contact us </a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-2 col-sm-4 col-xs-12 xs-margin-nine-bottom xs-text-center">
                    <ul class="links">
                        <li
                            class="text-medium margin-seven-bottom font-weight-600 text-white tz-text xs-margin-one-half-bottom">
                            Costumer Service </li>
                        <li><a class="tz-text text-medium-gray inner-link" href="{{url('/')}}/terms-&-conditions">Terms & Conditions</a>
                        </li>
                        <li><a class="tz-text text-medium-gray inner-link" href="{{url('/')}}/helps-&-faq">Helps & FAQ</a></li>
                        <li><a class="tz-text text-medium-gray inner-link" href="{{url('/')}}/size-guide">Size guide</a></li>
                        <li><a class="tz-text text-medium-gray inner-link" href="{{url('/')}}/shipping-and-delivery">Shipping and
                                Delivery</a></li>
                        <li><a class="tz-text text-medium-gray inner-link" href="{{url('/')}}/returns-and-exchange">Returns and
                                Exchange</a></li>
                ...
                <div class="col-md-2 col-sm-4 col-xs-12 xs-margin-nine-bottom xs-text-center">
                    <ul class="links">
                        <li
                            class="text-medium margin-seven-bottom font-weight-600 text-white tz-text xs-margin-one-half-bottom">
                            About FIGHTOR</li>
                        <li><a class="tz-text text-medium-gray inner-link" href="{{url('/')}}/about-us">About Us/Our story </a></li>
                        <li style="display: flex; gap: 10px; margin-top: 10px;">
                            <a href="https://www.facebook.com/profile.php?id=100088389605195">
                                <img style="height: 35px; width: 35px;" src="{{ asset('public/images/icons/facebook.png') }}" />
                            </a>
                            <a href="https://instagram.com/fightorsports?igshid=MzRlODBiNWFlZA==">
                                <img style="height: 35px; width: 35px;" src="{{ asset('public/images/icons/instagram.png') }}" />
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="border-top margin-five-top padding-five-top tz-border">
                        <div class="col-md-6 col-sm-6 col-xs-12 display-table xs-text-center xs-margin-nine-bottom">
                            <div class="display-table-cell-vertical-middle">
                                <span class="tz-text text-small">&copy; 2016 LeadGen is Proudly Powered By <a class="text-light-gray2" href="../../../../index.html">ThemeZaa.</a></span>
                            </div>
                        </div>
